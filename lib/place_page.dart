...
class PlacePageState extends State<PlacePage>{
  ...
  Widget build(BuildContext context) {
    ...
    Widget title = Container(
        ...
        child: Row(
          children: <Widget>[
            ...
            Icon(widget.liked? Icons.favorite : Icons.favorite_border, color: Colors.pink,),
            Text("41")
          ],
        )
    );
    Widget buttons = Row(
      ...
      children: <Widget>[
        _buildButtonsColumn(Colors.pinkAccent, Icons.call, "CALL"),
        _buildButtonsColumn(Colors.pinkAccent, Icons.near_me, "ROUTE"),
        _buildButtonsColumn(Colors.pinkAccent, Icons.share, "SHARE"),
      ],
    );
